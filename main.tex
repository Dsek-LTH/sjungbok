...
\fancyhead[RO]{\hfill \footnotesize\scshape\rightmark \hfill}
...
\begin{center}
   ...
   \includegraphics[width=0.6\textwidth]{D-symbol.pdf}
\end{center}
...
\begin{center}
   ...
   \includegraphics[width=1.0\textwidth]{bordsvisor.png}
   \section{Bordsvisor}
...
\begin{picture}(50,50) \put(150,-45){\hbox{\includegraphics[scale=0.35]{katt.png}}} \end{picture}
...
\end{parse lines}
\vfill
\noindent\textit{Skrevs på 45 minuter medans sittningen riggades.}
...
\begin{center}
   ...
   \includegraphics[width=0.8\textwidth]{snapsvisor.jpg}
   \section{Snapsvisor}
...
\begin{center}
   ...
   \includegraphics[width=0.8\textwidth]{vinvisor.jpg}
   \section{Vinvisor}
...
\begin{center}
   ...
   \includegraphics[width=1.0\textwidth]{olvisor.jpg}
   \section{Ölvisor}
...
\textit{Bordsvisa D-sektionen 2018}\\
...
\begin{center}
   ...
   \includegraphics[width=0.9\textwidth]{punschvisor.jpg}
   \section{Punschvisor}
...
\newpage
%\includegraphics[height=0.2\textheight]{kretslopp.png} 
%\vspace*{-0.2\textheight}

\begin{picture}(50,50) \put(155,0){\hbox{\includegraphics[height=0.15\textheight]{kretslopp.png}}} \end{picture}
...
\begin{center}
   ...
   \includegraphics[width=0.9\textwidth]{hyllningsvisor.jpg}
...
Nu trettio år D funnits har,
vi firar det med fester.
Vi stöter ut en stor fanfar
med hjälp av vår orkester.
Vi hoppas att om trettio år
man sitter här som senior.
Och lyssnar på någon med samma passion
såsom vi har för vår kära D-sektion.
\end{parse lines}

\noindent\textit{Skrevs till 20-års jubileumet, men sista versen skrevs om till 30-års jubileumet: 
preg\_replace(”tjugo”, ”trettio”, \$sang); }
...
\begin{center}
   ...
   \includegraphics[width=0.9\textwidth]{sektionsvisor.png}
...
\begin{center}
   ...
   \includegraphics[width=0.8\textwidth]{dchip.jpg}
   \section{D-Chip}
...
\begin{center}
   ...
   \includegraphics[width=1.0\textwidth]{nordigavisor.jpg}
...
\begin{center}
   ...
   \includegraphics[width=1.0\textwidth]{iqtest.png}
...
\begin{center}
   ...
   \includegraphics[width=1.0\textwidth]{eldiagram.png}
...
\begin{center}
   ...
   \includegraphics[width=1.0\textwidth]{sallskapsvisor.jpg}
...
\begin{center}
   ...
   \includegraphics[width=0.8\textwidth]{gamlavisor.png}
   \section{Gamla visor}
...
\begin{center}
   ...
   \includegraphics[width=1.0\textwidth]{drygavisor.jpg}
   \section{Dryga visor}
\end{center}
\vfill
\newpage
...
\vfill
\begin{center}
   \includegraphics[width=0.8\textwidth, frame]{klassiskavisor.jpg}
...
\vfill
\begin{center}
   \includegraphics[width=0.8\textwidth, frame]{friavisor.jpg}
   \section{Fria visor}
\end{center}
\vfill
\newpage
